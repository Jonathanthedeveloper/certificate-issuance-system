...
import { useCertificate } from "@/features";
        ...
        <div className="lg:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Official certificate document</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-900">{certificate.institution?.name}</p>
                <p className="text-sm text-gray-600">
                  {certificate.institution?.licenseNumber}
                </p>
              </div>
